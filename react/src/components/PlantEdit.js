...
class PlantEdit extends Component {
  ...
  componentDidMount () {
    this.setState({
      plantName: this.props.plant.common_name,
      nickname: this.props.plant.name,
      birthdate: this.props.plant.birthdate,
      sunlightNeeds: this.props.plant.sunlight_needs,
      wateringNeeds: this.props.plant.watering_needs,
      file: '',
      imagePreviewUrl: this.props.plant.photo,
      currentUser: {}
    });
  }
